...
<!-- BLOG:START -->
- **[Is Hand-Keyframing Dead? MotionHub Brings AI Into After Effects](https://zerblion.github.io/zero-build-blog/#/post/2026-07-16-motionhub)** — Describe motion on the right and get editable AE layers and keyframes on the left. MotionHub is turning that AI workflow into shared, extensible infrastructure. <sub>· 2026-07-16</sub>
- **[Claude Account Suspended? A VPS Might Be the Answer](https://zerblion.github.io/zero-build-blog/#/post/2026-07-05-vps-compliant-edge)** — Instead of jumping between devices, networks, and proxy chains, I prefer one sufficiently capable VPS: SSH-only if possible, or a lightweight Ubuntu desktop over Tailscale/RDP when I need a GUI. The goal is not evasion; it is a stable, explainable Claude work environment. <sub>· 2026-07-05</sub>
